...
export const GoalModal: React.FC<GoalModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-ink/60 backdrop-blur-sm transition-opacity">
      <div className="lg-card w-full max-w-lg rounded-t-[24px] sm:rounded-2xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col animate-in fade-in-50 slide-in-from-bottom-6 sm:zoom-in-95 duration-200 p-0 border-line">
